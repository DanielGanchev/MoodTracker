...
// This function will be used client-side only, so we import jsPDF dynamically
export const generateMoodPDF = async (
  ...
  try {
    ...
    const doc = new jsPDF('landscape') // Change to landscape for better column fitting
    ...
    // Create the table with improved column headers and widths
    autoTable(doc, {
      head: [
        [
          'Date',
